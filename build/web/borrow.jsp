...
<html>
    ...
    <body>
        ...
        <h2 style="margin-left:5%;">Our Library: </h2>
        <h5 style="margin-left:5%;">Borrow books with us at a nominal charge of a rupee for two days.:</h5>
        <div style="height: 500px; padding: 4%;margin-right: 10%;margin-left: 10%;text-align: center;">
        <%
            String q="select title, imgurl,id from book_collection where cond='old'";
